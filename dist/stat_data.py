...
conn_stats = [
    ...
    CacheStat('cache_eviction_server_dhandles_walked', 'eviction server dhandles walked for eviction'),
    ...
    CacheStat('cache_eviction_server_skip_dirty_updates_dominating_trees', 'eviction server skips trees that are predominantly occupied by dirty and updates bytes'),
