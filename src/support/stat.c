...
static const bool __stats_dsrc_user_facing[] = {
  false,
  false,
  false,
  false,
...
bool
__wt_stat_dsrc_user_facing(WT_CURSOR_STAT *cst, int slot, bool *p)
{
    WT_UNUSED(cst);
    *p = __stats_dsrc_user_facing[slot];
    return (0);
}
...
static const bool __stats_connection_user_facing[] = {
  false,
  false,
  false,
  false,
...
bool
__wt_stat_connection_user_facing(WT_CURSOR_STAT *cst, int slot, bool *p)
{
    WT_UNUSED(cst);
    *p = __stats_connection_user_facing[slot];
    return (0);
}
...
static const bool __stats_join_user_facing[] = {
  false,
  false,
  false,
  false,
...
bool
__wt_stat_join_user_facing(WT_CURSOR_STAT *cst, int slot, bool *p)
{
    WT_UNUSED(cst);
    *p = __stats_join_user_facing[slot];
    return (0);
}
...
static const bool __stats_session_user_facing[] = {
  false,
  false,
  false,
  false,
...
bool
__wt_stat_session_user_facing(WT_CURSOR_STAT *cst, int slot, bool *p)
{
    WT_UNUSED(cst);
    *p = __stats_session_user_facing[slot];
    return (0);
}
