...
extern bool __wt_session_prefetch_check(WT_SESSION_IMPL *session, WT_REF *ref)
  WT_GCC_FUNC_DECL_ATTRIBUTE((warn_unused_result));
extern bool __wt_stat_connection_user_facing(WT_CURSOR_STAT *cst, int slot, bool *p)
  WT_GCC_FUNC_DECL_ATTRIBUTE((warn_unused_result));
extern bool __wt_stat_dsrc_user_facing(WT_CURSOR_STAT *cst, int slot, bool *p)
  WT_GCC_FUNC_DECL_ATTRIBUTE((warn_unused_result));
extern bool __wt_stat_join_user_facing(WT_CURSOR_STAT *cst, int slot, bool *p)
  WT_GCC_FUNC_DECL_ATTRIBUTE((warn_unused_result));
extern bool __wt_stat_session_user_facing(WT_CURSOR_STAT *cst, int slot, bool *p)
  WT_GCC_FUNC_DECL_ATTRIBUTE((warn_unused_result));
